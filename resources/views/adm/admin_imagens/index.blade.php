...
@section('principalAdm')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-4">
                    <a href="#" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalNovaImagem">Nova
                        Imagem</a>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#modalEditImagem" onclick="openEditModal({{ json_encode($linha) }})">
                                    <i class="fa fa-pencil"></i>
                                </button>

                                <form action="{{ route('img_excluir', ['id' => $linha->id]) }}" method="POST"
        ...
        <div class="modal fade" id="modalNovaImagem" tabindex="-1" aria-labelledby="modalNovaImagemLabel"
            aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ route('SalvarNovaImagem') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="img_nome" placeholder="Nome da Imagem"
                                    required>
        ...
        <div class="modal fade" id="modalEditImagem" tabindex="-1" aria-labelledby="modalEditImagemLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
