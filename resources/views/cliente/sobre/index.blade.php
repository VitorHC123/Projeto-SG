    ...
    <div class="sobre_caixastxt">
        ...
        <div class="caixa2">
            ...
            <p>Ser reconhecida como a principal desenvolvedora de jogos que transforma o entretenimento digital,
                oferecendo produtos de qualidade superior que definem tendências e redefinem a maneira como as pessoas
                interagem com o mundo dos games.
                Nosso objetivo é expandir os limites do possível, criando universos virtuais que sejam tão imersivos quanto
                significativos.</p>
        </div>
        <hr>
        <div class="caixa3">
    ...
    <div class="sobre_quem_somos">
        ...
        <div class="quem_somostxt">
            <p class="txt_quemsomos">
                ...
                mas definir as tendências da indústria, criando jogos que inspiram, emocionam e transformam o entretenimento
                digital.
            </p>
        </div>
    </div>
